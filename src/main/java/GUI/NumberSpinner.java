...
public class NumberSpinner extends HBox {
    ...
    public static final BigDecimal MIN_VALUE_DECIMAL = new BigDecimal(MIN);
    public static BigDecimal MAX_VALUE_DECIMAL = new BigDecimal(MAX);
    ...
    private void increment() {
        ...
        if (value.compareTo(MAX_VALUE_DECIMAL) > 0) {
            value = MAX_VALUE_DECIMAL;
        }
